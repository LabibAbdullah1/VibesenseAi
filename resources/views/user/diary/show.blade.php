...
@section('title', 'Detail Diary') @section('content') <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div class="p-6 sm:p-8">
                            ...
                            <div class="flex items-center gap-3 mb-2">
                                ...
                                <div>
                                    ...
                                    <p class="text-2xl font-bold text-pink-800">
                                        {{ $diary->analysis->mood_score ?? 'N/A' }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            @else
                ...
                <div class="bg-gray-50 rounded-xl p-8 text-center border-2 border-dashed border-gray-300">
                    ...
                    <!-- Footer Actions -->
                    <div
                        class="bg-gray-50 px-6 sm:px-8 py-4 border-t border-gray-200 flex items-center justify-between gap-4">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <!-- Hidden Form -->
                            <form id="delete-detail-form" action="{{ route('user.diary.destroy', $diary->id) }}"
